...
#         FROM
#           `vibra-dtan-prd.rz_salesforce.Cases` AS Cases
#         LEFT JOIN
#           `vibra-dtan-prd.td_salesforce.AccountsMD` AS AccountsMD
#           ON
#             Cases.AccountId = AccountsMD.AccountId
#         LEFT JOIN
#           `vibra-dtan-prd.td_salesforce.UsersMD` AS CaseOwner
#           ON
#             Cases.OwnerId = CaseOwner.UserId
#         LEFT JOIN
#           `vibra-dtan-prd.td_salesforce.UsersMD` AS AccountOwner
#           ON
...
#   # from: case_management_v2

#   join: record_types {
#     type: left_outer
#     relationship: many_to_one
#     sql_on: ${record_types.record_type_id} = ${case_management.record_type_id};;
#   }
